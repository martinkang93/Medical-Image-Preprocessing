...
if __name__ == "__main__":
    ...
    patient_list = [os.path.join(train_data_path, name) for name in os.listdir(train_data_path) if os.path.isdir(os.path.join(train_data_path, name))]
    ...
    for patient in patient_list:
        ...
        np.save(os.path.join(output_directory, patient+"_CTVOL.npy"), image)
        np.save(os.path.join(output_directory, patient+"_label.npy"), label)
